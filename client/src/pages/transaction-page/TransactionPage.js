  ...
  const doTransactionStep = async () => {
    if (stepCounter === 1) {
      ...
      if (res.data.data === null) {
        ...
        setStepState(
          `Data found of Acc no ${res.data.data.acc} in Our System`
        );
      }
      ...
      setIsSentOther(true);
      setStepState(`Sent to other Insurance & Hospital to validate`);
      ...
      setOtherStepState(`Sent notification to Our System`);

      if (shouldAdd) {
        setNotification(
          `Insurance & Hospital has confirmed the block. Please add the Block to BC`
        );
      } else {
        setNotification(
          `Insurance & Hospital has rejected the block. Something wrong`
        );
      ...
      <div className="middle">
        <div className="middle_left">
          <div className="middle_left_top">
            ...
            <div className="branch">
              <h2 className="branch_top">Our System</h2>
          ...
          <div className="middle_left_bottom">
            <div className="branch">
              <h2 className="branch_top">Insurance</h2>
              <div className="branch_middle">
            ...
            <div className="branch">
              <h2 className="branch_top">Hospital</h2>
              <div className="branch_middle">
                <div className="workingStatus">{otherStepState}</div>
                <div className="notification">{othersNotification}</div>
              </div>
        ...
        <div className="middle_right">
          ...
          <div className="middle_right2">
            ...
            >
              6. Insurance & Hospital will check the block and send notification (yes/no)
            </div>
          </div>
